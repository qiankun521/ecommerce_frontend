...
let inventoryDefault = [
    ...
    {
        categories: ['热销','特卖', '沙发'], name: '达比特哑黑色', price: '1200', image: '/products/couch4.png', description: '你不需要出门也可以很粗旷。这款雪茄色原皮沙发采用坚固的实木框架和原始缝制,呈现马尔波罗男士的外观。这款棕色皮革沙发无论在山间小屋还是公寓都非常温馨。皮革会随使用变得越来越漂亮:像是昆虫叮咬、已愈合的伤疤和皮肤纹理的差异都反映了真正的复古感。跨上它,拿过遥控器吧。', currentInventory: 14
    },
    ...
    {
        categories: ['热销', '椅子'], name: '北欧躺椅', price: '825', image: '/products/chair2.png', description: '你不需要出门也可以很粗旷。这款雪茄色原皮沙发采用坚固的实木框架和原始缝制,呈现马尔波罗男士的外观。这款棕色皮革沙发无论在山间小屋还是公寓都非常温馨。皮革会随使用变得越来越漂亮:像是昆虫叮咬、已愈合的伤疤和皮肤纹理的差异都反映了真正的复古感。跨上它,拿过遥控器吧。', brand: '杰森·包恩', currentInventory: 13
    },
    {
